...
import me.zubi.domain.util.JSR310DateConverters.*;
...
@Configuration
@EnableMongoRepositories("me.zubi.repository")
...
public class CloudMongoDbConfiguration extends AbstractMongoConfiguration  {
    ...
    public Mongobee mongobee() throws Exception {
        ...
        mongobee.setChangeLogsScanPackage("me.zubi.config.dbmigrations");
