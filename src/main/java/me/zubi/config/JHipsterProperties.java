...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "m_gallery@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "m_gallery API";

        private String description = "m_gallery API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "m_gallery";
